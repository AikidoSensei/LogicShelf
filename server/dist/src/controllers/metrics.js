...
const getMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCartegorySummaryRaw = yield prisma.expenseByCategory.findMany({
            take: 5,
            orderBy: { date: 'desc' },
        });
        const expenseByCategorySummary = expenseByCartegorySummaryRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString() })));
